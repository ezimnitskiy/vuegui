...
constexpr quint16 DEFAULT_LOCAL_RPC_PORT = 18070;
constexpr char LOCAL_HOST[] = "127.0.0.1";

constexpr char VERSION[] = "1.0.0";
constexpr char VERSION_SUFFIX[] = "beta";
constexpr char REVISION[] = "20180310";

#if defined(Q_OS_LINUX)
constexpr char DEFAULT_WORK_DIR[] = ".vuecash";
#endif

constexpr char DEFAULT_WALLETD_PATH[] = "./walletd";

const constexpr char* DEFAULT_MINING_POOLS[] = {};
...
Settings::Settings()
{
    ...
    const QString jsonFile = getDefaultWorkDir().absoluteFilePath("vuecash-gui.config");
